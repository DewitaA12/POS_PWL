        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('/barang/' . $barang->barang_id) }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label col-form-label">Kode Barang</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label col-form-label">Harga Beli</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 control-label col-form-label">Harga Jual</label>
                    <div class="col-sm-10">
